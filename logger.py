...
class Logger:
    def __init__(self, trace_file, requests_file, level, formatter, date_format):
        ...
        # Class parameters
        self.__logger_trace = logging.getLogger("trace")
        self.__logger_requests = logging.getLogger("requests")
        ...
        self.__logger_trace.addHandler(trace_handler)
        ...
        self.__logger_requests.addHandler(requests_handler)

    def trace(self):
        return self.__logger_trace

    def requests(self):
        return self.__logger_requests
